...
public static class Vector4GetMinAxisName
{
	// Extension for vector4 data types to compare and return a 3D axis name that currently holds the smallest value.
	public static Axis4DOptional GetMinAxisName(this Vector4 inputVector4)
	{
